...
namespace Wave.OpenXR.Tracker
{
    ...
    /// </summary>
#if UNITY_EDITOR
    [OpenXRFeature(UiName = "VIVE Focus 3 Wrist Tracker",
    ...
    public class ViveWristTracker : OpenXRInteractionFeature
    {
        ...
        public class WristTrackerDevice : OpenXRDevice
        {
            ...
            /// <summary>
            /// A [ButtonControl](xref:UnityEngine.InputSystem.Controls.ButtonControl) that represents the <see cref="ViveWristTracker.menu"/> OpenXR bindings, depending on handedness.
            /// </summary>
