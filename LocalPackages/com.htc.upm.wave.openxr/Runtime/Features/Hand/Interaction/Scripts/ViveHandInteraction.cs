...
{
    /// <summary>
    /// This <see cref="OpenXRInteractionFeature"/> enables the use of hand interaction profiles in OpenXR. It enables XR_HTC_hand_interaction in the underyling runtime.
    /// This creates a new <see cref="InputDevice"/> with the <see cref="InputDeviceCharacteristics.HandTracking"/> characteristic.
    /// </summary>
#if UNITY_EDITOR
    [OpenXRFeature(UiName = "VIVE Focus 3 Hand Interaction",
    ...
    public class ViveHandInteraction : OpenXRInteractionFeature
    {
        ...
        /// <summary>The interaction profile string used to reference the hand interaction input device.</summary>
